...
pf_params['pf']['smart_pf'] = smart_pf
...
grabbers = tt.DatasetTools.GenGrabbers(params_ds, model3d, smart_pf)
if smart_pf: pf,rng = tt.ParticleFilterTools.GenSmartPF(pf_params, model3d, model3dobj.decoder)
else: pf,rng = tt.ParticleFilterTools.GenPF(pf_params,model3d)
