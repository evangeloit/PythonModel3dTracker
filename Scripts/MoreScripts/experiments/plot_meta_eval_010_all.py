...
expl_label= ['MOP-MF','STD','MOP','MHF(10)','MHF(20)','MHF(30)','MHF(40)','MHF(50)','MHF(100)']
...
sel_data = [SelData(['mop','mft','mhf','mhm','did'],['1','1','100','20','gtcircsta300']),
            SelData(['mop','mft','mhf','mhm','did'],['0','0','000','00','gtcircsta300']),
            SelData(['mop','mft','mhf','mhm','did'],['1','0','000','00','gtcircsta300'])]
...
ylim_metric=[[20,75],[0,0],[0,0],[0.5,3.5]]
ystep=[5,0,0,0.1]
