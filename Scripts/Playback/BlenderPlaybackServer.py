...
model_name = 'box'
res = 'boxiw3_large_gt'
results_txt = os.path.join(Paths.datasets, "object_tracking/co4robots/{}_blender2.json".format(res))
...
# Output options
results_txt_out = None #os.path.join(Paths.datasets, "object_tracking/co4robots/{}_blender2.json".format(res))
