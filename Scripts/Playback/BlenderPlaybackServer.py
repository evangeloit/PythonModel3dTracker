...
dtpath = '/home/evangeloit/Desktop/GitBlit_Master/PythonModel3dTracker/Data/data/S01/A01/'
calib_file = '/home/evangeloit/Desktop/GitBlit_Master/PythonModel3dTracker/Data/data/calib.txt'
# Input
# for name in range(0,len(dtname)):
wait_time = 1
dataset =dtpath#+dtname[0]+'.json'
